    ...
    <select name="ArrivalCity" class="form-control">
        ...
        @endforeach
                         ...
                         <div class="col-md-6">
                            ...
                            <input type="time" class="form-control" name="DepartureTime" value="{{ $booking->flightmaster->DepartureTime }}">
                        </div>
                        <div class="col-md-6">
                            <label style="font-weight: bold;">Arrival Time</label>
                            <input type="time" class="form-control" name="ArrivalTime" value="{{ $booking->flightmaster->ArrivalTime }}">
                        </div>
                    </div>
                    </div>
                    <div class="row">
